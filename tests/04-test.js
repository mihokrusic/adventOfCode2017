...
const day04 = require('../solutions/04.js');
...
describe('Day 4', () => {
	...
	describe('Part 1', () => {
		it('aa bb cc dd ee is valid', 		() => assert.equal(1, day04.part_one('aa bb cc dd ee')));
		it('aa bb cc dd aa is not valid', 	() => assert.equal(0, day04.part_one('aa bb cc dd aa')));
		it('aa bb cc dd aaa is valid', 		() => assert.equal(1, day04.part_one('aa bb cc dd aaa')));
		it('advent test input', 			() => assert.equal(455, day04.part_one(largeInput)));
	});

	describe('Part 2', () => {
		it('abcde fghij is valid', 				() => assert.equal(1, day04.part_two('abcde fghij')));
		it('abcde xyz ecdab is not valid', 		() => assert.equal(0, day04.part_two('abcde xyz ecdab')));
		it('a ab abc abd abf abj is valid', 	() => assert.equal(1, day04.part_two('a ab abc abd abf abj')));
		it('iiii oiii ooii oooi oooo is valid', () => assert.equal(1, day04.part_two('iiii oiii ooii oooi oooo')));
		it('oiii ioii iioi iiio is valid', 		() => assert.equal(0, day04.part_two('oiii ioii iioi iiio')));
		it('advent test input', 				() => assert.equal(186, day04.part_two(largeInput)));
	});
});