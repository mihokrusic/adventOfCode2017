...
const day08 = require('../solutions/08.js');
...
describe('Day 8', () => {
	...
	describe('Part 1', () => {
		it('sample input', 	() => assert.equal(1, day08.part_one(sample)));
		it('sample2 input', () => assert.equal(5, day08.part_one(sample2)));
		it('sample3 input', () => assert.equal(10, day08.part_one(sample3)));
		it('test input', 	() => assert.equal(5075, day08.part_one(test)));
	});

	describe('Part 2', () => {
		it('sample input', 	() => assert.equal(10, day08.part_two(sample)));
		it('sample3 input', () => assert.equal(15, day08.part_two(sample3)));
		it('test input', 	() => assert.equal(7310, day08.part_two(test)));
	});
});